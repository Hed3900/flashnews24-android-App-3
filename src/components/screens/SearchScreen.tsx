...
export const SearchScreen: React.FC<SearchScreenProps> = ({
  ...
  return (
    <div className="flex flex-col h-full bg-inherit animate-in fade-in duration-200">
      ...
      <div className="p-3 border-b border-[#252629] sticky top-0 bg-inherit z-30 flex items-center gap-2">
        <div className="flex-1 relative flex items-center">
          ...
          <input
            ...
            autoFocus
            className="w-full bg-[#08090A] text-xs text-white rounded-[24px] pl-10 pr-9 py-2.5 outline-none border border-[#252629] focus:border-red-500 transition-all font-medium placeholder:text-[#E1E4E8]/40"
          />
          {query.length > 0 && (
            <button
              onClick={() => setQuery('')}
        ...
        <button
          onClick={onClose}
          className="text-xs font-bold text-red-400 px-2 py-1 hover:opacity-80 transition-opacity"
        >
          Cancel
        </button>
      </div>
      ...
      <div className="flex-1 overflow-y-auto p-3.5 space-y-4">
        {query.trim() === '' ? (
          <div className="space-y-4 pt-2">
              ...
              <div className="flex flex-wrap gap-2">
                {TRENDING_KEYWORDS.map((kw) => (
                  <button
                    key={kw}
                    onClick={() => setQuery(kw)}
                    className="px-3.5 py-1.5 rounded-[24px] bg-[#08090A] text-xs font-semibold hover:bg-red-600 hover:text-white transition-all text-[#E1E4E8] border border-[#252629] shadow-sm"
                  >
                    {kw}
                  </button>
                ))}
            ...
            <div className="p-4 rounded-[24px] bg-[#111214] border border-[#252629] text-center space-y-2 mt-6 shadow-xl">
              <Sparkles className="w-6 h-6 text-red-500 mx-auto" />
          ...
          <div className="text-center py-16 px-4">
            <Search className="w-8 h-8 text-red-500 mx-auto mb-2 opacity-50" />
            ...
            {filtered.map((art) => (
              ...
              >
                ...
                <div className="flex-1 flex flex-col justify-between min-w-0">
                  <div>
                    <div className="flex items-center justify-between text-[10px] font-bold text-red-400 mb-0.5">
                  ...
                  <div className="flex items-center justify-between pt-1.5 mt-1 border-t border-[#252629] text-[10px] text-[#E1E4E8] opacity-60">
